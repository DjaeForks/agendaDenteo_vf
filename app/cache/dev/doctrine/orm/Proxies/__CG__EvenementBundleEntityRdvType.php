 ...
 */
class RdvType extends \EvenementBundle\Entity\RdvType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EvenementBundle\\Entity\\RdvType' . "\0" . 'id', 'user', 'rdvs', '' . "\0" . 'EvenementBundle\\Entity\\RdvType' . "\0" . 'titre', '' . "\0" . 'EvenementBundle\\Entity\\RdvType' . "\0" . 'duree', '' . "\0" . 'EvenementBundle\\Entity\\RdvType' . "\0" . 'couleur', '' . "\0" . 'EvenementBundle\\Entity\\RdvType' . "\0" . 'description'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RdvType $proxy) {
