...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'jms_job_queue.retry_scheduler' => 'getJmsJobQueue_RetrySchedulerService',
            'jms_job_queue.scheduler_registry' => 'getJmsJobQueue_SchedulerRegistryService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EvenementBundle\Service\CalendarService A EvenementBundle\Service\CalendarService instance.
     */
    protected function getCalendarService()
    {
        return $this->services['calendar'] = new \EvenementBundle\Service\CalendarService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'denteo2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\UsersBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\EvenementBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\PatientBundle\\Entity'), 3 => ($this->targetDirs[3].'\\vendor\\jms\\job-queue-bundle\\JMS\\JobQueueBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UsersBundle\\Entity');
        $c->addDriver($b, 'EvenementBundle\\Entity');
        $c->addDriver($b, 'PatientBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UsersBundle' => 'UsersBundle\\Entity', 'EvenementBundle' => 'EvenementBundle\\Entity', 'PatientBundle' => 'PatientBundle\\Entity', 'JMSJobQueueBundle' => 'JMS\\JobQueueBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8c16fd8c39cc1369e3104a8c0ee887cacd813f2302af8ea82cf42ce3a60ffc11');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('\\UsersBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), '\\UsersBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'jms_job_queue.retry_scheduler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \JMS\JobQueueBundle\Retry\ExponentialRetryScheduler A JMS\JobQueueBundle\Retry\ExponentialRetryScheduler instance.
     */
    protected function getJmsJobQueue_RetrySchedulerService()
    {
        return $this->services['jms_job_queue.retry_scheduler'] = new \JMS\JobQueueBundle\Retry\ExponentialRetryScheduler();
    }

    /**
     * Gets the 'jms_job_queue.scheduler_registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \JMS\JobQueueBundle\Cron\SchedulerRegistry A JMS\JobQueueBundle\Cron\SchedulerRegistry instance.
     */
    protected function getJmsJobQueue_SchedulerRegistryService()
    {
        return $this->services['jms_job_queue.scheduler_registry'] = new \JMS\JobQueueBundle\Cron\SchedulerRegistry(array());
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('default_target_path' => '/all', 'always_use_default_target_path' => true, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('lidrissihamid@gmail.com');
        $a->setPassword('idrissi06');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\UsersBundle/Resources/views'), 'Users');
        $instance->addPath(($this->targetDirs[3].'\\src\\EvenementBundle/Resources/views'), 'Evenement');
        $instance->addPath(($this->targetDirs[3].'\\src\\PatientBundle/Resources/views'), 'Patient');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\jms\\job-queue-bundle\\JMS\\JobQueueBundle/Resources/views'), 'JMSJobQueue');
        $instance->addPath(($this->targetDirs[3].'\\src\\command\\commandBundle/Resources/views'), 'command');
    ...
    {
        return $this->services['twilio.api'] = new \Vresh\TwilioBundle\Service\TwilioWrapper('ACc337e76cfa8d20fd0af54c6a58cfbc91', 'c30d9fececc07d052bfc3f72ffd12781', '2010-04-01', 3);
    }
    ...
    {
        return $this->services['twilio.capability'] = new \Vresh\TwilioBundle\Service\TwilioCapabilityWrapper('ACc337e76cfa8d20fd0af54c6a58cfbc91', 'c30d9fececc07d052bfc3f72ffd12781');
    }
    ...
    {
        return $this->services['twilio.lookups'] = new \Vresh\TwilioBundle\Service\TwilioLookupsWrapper('ACc337e76cfa8d20fd0af54c6a58cfbc91', 'c30d9fececc07d052bfc3f72ffd12781');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a5ae73239ac7813b6de24888e42d4e4b8809bdab');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UsersBundle' => 'UsersBundle\\UsersBundle',
                'EvenementBundle' => 'EvenementBundle\\EvenementBundle',
                'PatientBundle' => 'PatientBundle\\PatientBundle',
                'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle',
                'JMSJobQueueBundle' => 'JMS\\JobQueueBundle\\JMSJobQueueBundle',
                'commandBundle' => 'command\\commandBundle\\commandBundle',
            ...
            'secret' => 'a5ae73239ac7813b6de24888e42d4e4b8809bdab',
            'locale' => 'fr',
            ...
            'kernel.secret' => 'a5ae73239ac7813b6de24888e42d4e4b8809bdab',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'lidrissihamid@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'idrissi06',
            ...
            'fos_user.model.user.class' => '\\UsersBundle\\Entity\\User',
            ...
            'jms_job_queue.scheduler_registry.class' => 'JMS\\JobQueueBundle\\Cron\\SchedulerRegistry',
